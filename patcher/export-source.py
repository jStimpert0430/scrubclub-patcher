...
The patcher installs Blue Depot, Road Lights, Sleep Vote, the compatible MultiUserChest fork, Jötunn and BepInEx. Road Lights removes decorative-light fuel upkeep and station requirements, and adds optional free freestanding lights when using the hoe's Pathen tool. Sleep Vote asks awake players to approve passing the night, with a 30-second grace period to get into bed after unanimous approval. Downloads come from GitHub over HTTPS and are signature-checked before installation. Existing configuration is preserved; replaced files are backed up. No home-network hosting service or server credentials are involved.
